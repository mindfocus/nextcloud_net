...
class Component : Node
{
     ...
     * @var array
     */
    protected IList<Component> _children = new List<Component>();
     ...
     * @param bool     defaults
     */
    public Component(Document root, string name, IDictionary<string, Component> children , bool defaults = true)
    {
