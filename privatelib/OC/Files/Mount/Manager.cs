...
class Manager : IMountManager {
	 ...
	 */
	public MountPoint find(string path) {
		OC_Util.setupFS();
	 ...
	 * @return MountPoint[]
	 */
	public IList<IMountPoint> findIn(string path){
		OC_Util.setupFS();
	 ...
	 * @return MountPoint[]
	 */
	public IList<IMountPoint> findByStorageId(string id) {
		OC_Util.setupFS();
		if (\strlen(id) > 64) {
			id = md5(id);
		}
	 ...
	 * @return MountPoint[]
	 */
	public IList<IMountPoint> findByNumericId(int id) {
