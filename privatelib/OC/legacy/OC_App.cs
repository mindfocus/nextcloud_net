...
namespace OC.legacy
{
    ...
    {
	static private IList<string> adminForms = new List<string>();
	static private IList<string> personalForms = new List<string>();
	static private IList<string> appTypes = new List<string>();
	static private IList<string> loadedApps = new List<string>();
	static private IList<string> altLogin = new List<string>();
	static private IList<string> alreadyRegistered = new List<string>();
	static public IList<string> autoDisabledApps = new List<string>();
	const int officialApp = 200;
	const int supportedApp = 300;
	...
	public static string cleanAppId(string app) {
		var replaceHolder = new List<string>() {".0", "/", "..", ".."};
		foreach (var holder in replaceHolder)
		{
			app.Replace(holder, "");
		}
		return app;
...
//		ob_end_clean();
	 ...
	 * @param string path
	 */
	public static void registerAutoloading(string app, string path) {
		key = app . "-" . path;
	 ...
	 * @throws Error
	 */
	private static void requireAppFile(string app) {
	 ...
	 * @return array
	 */
	private static IList getAppTypes(string app) {
		//load the cache
