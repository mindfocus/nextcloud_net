...
namespace OCP
{
	 ...
	 * @since 6.0.0
	 */
	object getParam(string key, object @default = null);
	 ...
	 * @since 8.1.0
	 */
	bool isUserAgent(IList<string> agent);
