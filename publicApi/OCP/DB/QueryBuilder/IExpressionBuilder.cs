...
namespace OCP.DB.QueryBuilder
{
    ...
    public interface IExpressionBuilder
    {
         ...
         * @since 8.2.0
         */
        ICompositeExpression andX(params string[] x);
         ...
         * @since 8.2.0
         */
        ICompositeExpression orX(params string[] x);
         ...
         * @since 9.0.0
         */
        string iLike(string x, object y, object type = null);
	...
	string notIn(string x, string y, object type = null);
         ...
         * @since 13.0.0
         */
        string nonEmptyString(string x);
         ...
         * @since 12.0.0
         */
        IQueryFunction bitwiseAnd(string x, int y);
         ...
         * @since 12.0.0
         */
        IQueryFunction bitwiseOr(string x, int y);
         ...
         * @since 8.2.0
         */
        string literal(object input, object type = null);
         ...
         * @since 9.0.0
         */
        string castColumn(string column, object type);
    }
