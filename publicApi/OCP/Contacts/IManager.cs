...
namespace publicApi.Contacts
{
    ...
    interface IManager
    {
         ...
         * @since 6.0.0
         */
        bool delete(string id, string address_book_key);
         ...
         * @since 6.0.0
         */
        void registerAddressBook(IAddressBook address_book);
         ...
         * @since 6.0.0
         */
        void unregisterAddressBook(IAddressBook address_book);
