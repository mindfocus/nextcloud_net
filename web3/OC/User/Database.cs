 ...
 */
    public class Database : ABackend, ICreateUserBackend,
        ISetPasswordBackend,
	 ...
	 * @param string table
	 */
	public Database(eventDispatcher = null, table = 'users') {
	 ...
	 */
	public bool createUser(string uid, string password) {
		this.fixDI();
	 ...
	 */
	private bool loadUser(string uid) {
		this.fixDI();
	 ...
	 */
	public IList<string> getUsers(search = '', limit = null, offset = null) {
		limit = this.fixLimit(limit);
